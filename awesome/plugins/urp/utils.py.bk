...
yzm_url = codeurl = 'http://jwurp.hhuc.edu.cn/validateCodeAction.do?random=0.42202007908415373'
post_url = Url = 'http://jwurp.hhuc.edu.cn/loginAction.do'
...
async def search(id, passwd):
    ...
    print(link_cj)
    cj = requests.get(link_cj, headers=Headers)
    cj.encoding = 'GBK'
    with open("demo.html", "wb") as html:
